...
try:
    ...
    ('Song One', %s, pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/6363 - Dúvad Csulák (Official Music Video).mp3'),pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/a9626ea3e412db8643379e1dd050b8cf.1000x1000x1.png'), 210, 0),
    ('Song Two', %s, pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/chinesemidiboard - air freshener.mp3'),pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/a0031934097_65.jpg'), 180, 5),
    ('Song Three', %s, pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/femtanyl - KATAMARI.mp3'),pg_read_binary_file('/Applications/PostgreSQL 16/temp music folder/0x1900-000000-80-0-0.jpg'), 150, 10);
    """, (
        user_ids["Dr. Assman"],
        user_ids["John Doe"],
        user_ids["Jane Smith"]
